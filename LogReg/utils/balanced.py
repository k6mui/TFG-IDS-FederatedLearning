...
def rebalance_dataframe(df, label_col='Label', majority_class=0, minority_class=1, majority_target=600000, minority_target=400000):
...
def balance(path1=path1,path2=path2,path3=path3):
    ...
    print("df_cic['Attack']:")
    print(df_cic['Attack'].value_counts().to_string())

    print("\ndf_nb15['Attack']:")
    print(df_nb15['Attack'].value_counts().to_string())

    print("\ndf_toniot['Attack']:")
    print(df_toniot['Attack'].value_counts().to_string())
