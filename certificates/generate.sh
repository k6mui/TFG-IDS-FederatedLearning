...
# "This script is designed to generate a pair of SSL certificates: 
# a root Certificate Authority (CA) certificate and a server certificate signed by that CA"
...
openssl genrsa -out $CERT_DIR/ca.key 4096 # This command generates a new 4096-bit RSA private key and saves it to ca.key in the CERT_DIR directory.
