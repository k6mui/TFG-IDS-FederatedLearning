...
# path1 = "../datasets/balanced/cicids_balanced.csv"
# path2 = "../datasets/balanced/nb15_balanced.csv"
# path3 = "../datasets/balanced/toniot_balanced.csv"
...
model = dnn.create_NN(num_features=x_trainCic.shape[1])
history = model.fit(x_trainCic, y_trainCic, epochs=5, batch_size=128, verbose=1, validation_split = 0.1)
